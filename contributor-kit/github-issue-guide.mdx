...
- `Practitioner Skill Package`: new or substantially revised Codex-compatible
  packages under `skills/`. These are code-plus-docs contributions, not
...
installable skill under `skills/`.
