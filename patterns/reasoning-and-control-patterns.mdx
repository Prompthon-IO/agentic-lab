...
- Source input: [Chapter 4 Building Classic Agent Paradigms](https://github.com/Prompthon-IO/agentic-lab/blob/main/references/hello-agents-main/docs/chapter4/Chapter4-Building-Classic-Agent-Paradigms.md)
