...
| Personal Knowledge Capture | [`skills/personal-knowledge-capture/README.md`](https://github.com/Prompthon-IO/agentic-lab/blob/main/skills/personal-knowledge-capture/README.md) | Local-first watch-path registration, incremental source detection, SQLite state, and cited Markdown note generation |
