...
- `Practitioner Skill Package`：位于 `skills/` 下的新建或大幅修订的 Codex 兼容技能包。这类 issue 是代码加文档的贡献，不是纯文档 issue。
...
当工作是在 `skills/` 下创建或修订可安装技能包时，请使用 `Practitioner Skill Package` 表单。
